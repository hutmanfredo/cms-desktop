...
const columns: Column[] = [
  { id: 1, label: 'Firs name', minWidth: 10, align: 'left' }, 
  { id: 6, label: 'Given names', minWidth: 20, align: 'center' },
  { id: 6, label: 'Username', minWidth: 20, align: 'center' },
  { id: 12, label: 'Role', minWidth: 20, align: 'center' },
                ...
                {data.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row, i) => {
                  return (
                    <TableRow hover role="checkbox" tabIndex={-1} key={i}>
                      <TableCell sx={{ fontSize: 12 }}>{row.fname}</TableCell>
