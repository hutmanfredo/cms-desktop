...
function AttendanceMembers(): JSX.Element {
  ...
  const handleMenuClick = (event: unknown): void => {
  ...
  return (
    <>
      <TopBarWithArrowBack
        onClick={() => navigate(-1)}
        title={`${titletxt} / Members attendance`}
      />
      <Box
        sx={{
          width: '100%',
      ...
      >
        <TopBarWithSearch
          ...
          btnTxt="Member"
          onClick={() => setOpenNewArrival(!openNewArrival)}
        />
