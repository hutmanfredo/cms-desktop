...
function ZoneMembers(): JSX.Element {
  ...
  return (
    <>
      ...
      <ZoneNewMember open={openNewMember} handleClose={() => setOpenNewMember(!openNewMember)} />
      <ZoneTransfer
        open={openZoneTransfer}
        handleClose={() => setOpenZoneTransfer(!openZoneTransfer)}
      />
    </>
  )
}

export default ZoneMembers
