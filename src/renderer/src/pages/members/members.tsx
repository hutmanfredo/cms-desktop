...
import MemberTransfer from '@renderer/components/member/MemberTransfer'
...
const columns: Column[] = [
  { id: 1, label: 'MemberID', minWidth: 10, align: 'left' },
  ...
  { id: 5, label: 'DoB', minWidth: 20, align: 'center' },
  { id: 6, label: 'Phone', minWidth: 20, align: 'center' },
  { id: 6, label: 'Email', minWidth: 20, align: 'center' },
  { id: 7, label: 'Type', minWidth: 20, align: 'center' },
  { id: 9, label: 'Program', minWidth: 20, align: 'center' },
  { id: 8, label: 'Level', minWidth: 20, align: 'center' },
  { id: 10, label: 'Residence', minWidth: 20, align: 'center' },
  //{ id: 11, label: 'Branch', minWidth: 20, align: 'center' },
...
function Members(): JSX.Element {
  ...
  return (
    <>
                ...
                {data.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row, i) => {
                  return (
                    <TableRow hover role="checkbox" tabIndex={-1} key={i}>
                      <TableCell sx={{ fontSize: 12 }}>{row.memberid}</TableCell>
      ...
      <MemberTransfer open={openTransfer} handleClose={() => setOpenTransfer(!openTransfer)} />
    </>
  )
}
