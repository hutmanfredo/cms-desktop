...
const columns: Column[] = [
  { id: 1, label: 'Date', minWidth: 10, align: 'left' },
  { id: 2, label: 'Income', minWidth: 20, align: 'center' },
  { id: 3, label: 'Description', minWidth: 20, align: 'center' },
  { id: 4, label: 'Mode', minWidth: 20, align: 'center' },
  { id: 5, label: 'Amount (GH¢)', minWidth: 20, align: 'center' },
  { id: 6, label: 'Recieved from', minWidth: 20, align: 'center' },
  ...
  return (
    ...
    >
      <TopBarWithSearch
        ...
        btnTxt="Income"
        onClick={() => navigate('/finance/newincome')}
      />
      ...
      <Box sx={{ width: '100%', mt: 1, overflow: 'hidden' }}>
        ...
        >
          <MenuItem
            ...
            onClick={() => navigate('/finance/updateincome')}
          >
            Edit Income
          </MenuItem>
          <MenuItem
